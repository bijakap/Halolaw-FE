        ...
        <div className="mx-[25px] lg:mx-[100px]">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-4 mx-[0px] lg:mx-[60px] gap-[16px] lg:gap-[32px]">
                <div className="flex justify-center">
                    <div className="flex flex-col lg:justify-between bg-[#FCFCFC] border shadow-[0_18px_58px_16px_rgba(0,0,0,0.06)] w-full lg:w-[256px] h-auto lg:h-[278px] p-[12px] lg:p-[24px] hover:border hover:border-blue-700 cursor-pointer" onClick={() => {router.push('/kategori/Properti')}}>
                ...
                <div className="flex justify-center">
                    <div className="flex flex-col lg:justify-between bg-[#FCFCFC] border shadow-[0_18px_58px_16px_rgba(0,0,0,0.06)] w-full lg:w-[256px] h-auto lg:h-[278px] p-[12px] lg:p-[24px] hover:border-blue-700 cursor-pointer" onClick={() => {router.push('/kategori/Properti')}}>
                        <div className="w-[32px] h-[32px] lg:w-[64px] lg:h-[64px]">
