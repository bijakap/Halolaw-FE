    ...
    return(
        <div className='block'>
            <div className="relative">
                <div className="absolute -z-10 bg-gradient-to-r from-[#3D8DFF] to-[#2A41C7] h-[100px] md:h-[110px] lg:h-[140px] w-full">
            ...
            <div className="text-white mx-[25px] lg:mx-[100px] space-y-[0px] lg:space-y-[16px] py-[12px] lg:py-[32px]">
                ...
                <div>
                    <p className="font-[700] text-[28px] md:text-[33px] leading-0 lg:leading-[40px] tracking-[0.25px] text-left">Reservasi Konsultasi</p>
                </div>
            </div>
            <div className='border-b pb-10'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[105px] pt-10 mx-10 lg:mx-[100px] text-[#1D2939]'>
                    <div>
                        ...
                        <div className='flex ml-8 flex-col w-full md:w-[45%]'>
