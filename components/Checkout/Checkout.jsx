...
export default function Checkout() {
  ...
  const optionBank = [
    ...
    {
      value: "Transfer - Bank Cimb Niaga",
      label: "Transfer - Bank Cimb Niaga",
    },
  ];
  ...
  return (
    <div className="block lg:flex lg:justify-center ml-6 md:ml-[50px] lg:ml-0 mr-6 md:mr-[50px] lg:mr-[100px] mt-[60px]">
      <div className="mr-[40px] xl:mr-[86px] mb-5 xl:mb-0">
        <button
          className="flex justify-center bg-[#F2F4F7] hover:bg-[#E4E7EC] px-6 py-[6px] rounded-[8px] w-[128px]"
          onClick={() => {
            router.back();
          }}
        >
      ...
      <div className="flex flex-col md:flex-row">
        <div className="mr-0 md:mr-[40px] xl:mr-[80px] w-auto md:w-[336px] xl:w-[397px]">
          <div className="space-y-[8px] mb-10">
            <h1 className="text-[33px] font-[700] leading-[40px] tracking-[0.25px] text-[#1D2939]">
              Checkout
            </h1>
            <p className="text-[14px] leading-[20px] tracking-[0.25px] text-[#475467]">
              Lengkapi data diri & pastikan semuanya sudah benar
            </p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-700 tracking-wide">
              Nama Lengkap <span className="text-[#3A57E8]">*</span>
            </label>
            <input
              className=" w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#3A57E8] mt-2 mb-4 placeholder:text-sm placeholder:text-[#98A2B3] placeholder:font-regular"
              type="text"
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 tracking-wide">
              Nomor Telepon <span className="text-[#3A57E8]">*</span>
            </label>
            <input
              className=" w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#3A57E8] mt-2 mb-4 placeholder:text-sm placeholder:text-[#98A2B3] placeholder:font-regular"
              type="number"
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 tracking-wide">
              Alamat Lengkap <span className="text-[#3A57E8]">*</span>
            </label>
            <textarea
              className=" w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#3A57E8] mt-2 mb-4 resize-none placeholder:text-sm placeholder:text-[#98A2B3] placeholder:font-regular"
              type="text"
              placeholder="Contoh:  jl. Telekomunkasi no.1, Dayeuhkolot, kabupaten Bandung, kode pos 40257"
              rows="4"
            />
          </div>
        </div>
        <div className="w-auto md:w-[336px] border">
          <div className="bg-[#E4E7EC] text-left">
            <h1 className="text-[#1D2939] text-[23px] leading-[32px] font-[700] px-6 py-4">
              Pembayaran
            </h1>
          </div>
          <div className="p-6 bg-white">
            <div className="mb-[32px]">
              <label className="text-sm font-medium text-gray-700 tracking-wide">
                Metode Pembayaran <span className="text-[#3A57E8]">*</span>
              </label>
              <div className="mt-4">
                <Select
                  options={optionBank}
            ...
            <div className="mb-[32px]">
              <label className="text-sm font-medium text-gray-700 tracking-wide">
                Domisili Pengurusan <span className="text-[#3A57E8]">*</span>
              </label>
              <div className="mt-4">
                <Select
                  options={options}
            ...
            <div className="border-b-2 pb-4">
              <h1 className="text-sm font-bold text-[#344054] tracking-wide pb-4">
                Ringkasan Belanja
              </h1>
              <div className="space-y-[8px]">
                <div className="flex justify-between text-sm text-[#475467]">
                  <p>Pembuatan Dokumen</p>
                  <p className="font-bold">Rp 700.000</p>
                </div>
                <div className="flex justify-between text-sm text-[#475467]">
                  <p>Konsultasi</p>
                  <p className="font-bold">Rp 0 (gratis)</p>
                </div>
                <div className="flex justify-between text-sm text-[#475467]">
                  <p>Kode unik</p>
                  <p className="font-bold">Rp 100</p>
                </div>
              </div>
            </div>
