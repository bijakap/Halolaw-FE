      ...
      <div className="w-full">
        <div className="flex justify-center w-full mb-10">
          <div className="w-full space-y-[8px]">
            ...
            <h5 className="text-center text-[23px] leading-[32px] font-[600] text-[#344054]">
              TRANSAKSI BERHASIL
            </h5>
          </div>
        </div>
        <div className="border rounded-[8px] shadow-[0px_4px_16px_0px_rgba(58,87,232,0.1)] py-4">
          <div className="flex justify-between px-10 border-b pb-4">
            <h5 className="self-center text-[16px] leading-[20px] tracking-[0.15px] font-[500]">
              Bank Mandiri - Transfer manual
            </h5>
            <img src="mandiri.png" />
          </div>
          <div className="flex justify-between px-10 mt-6 text-[14px] text-[#667085] leading-[20px] tracking-[0.25px]">
            <div className="space-y-[4px]">
              ...
              <p className="text-[19px] text-[#101828] font-[600] leading-[24px]">
                028846670391
              </p>
            </div>
            <div className="self-end">
              <button
                className="flex font-[600] gap-1 hover:text-gray-700"
                style={{
                  color: isActive ? "#2A41C7" : "#667085",
                }}
                onClick={handleClick}
              >
          ...
          <div className="flex justify-between px-10 mt-6 text-[14px] text-[#667085] leading-[20px] tracking-[0.25px] pb-4">
            ...
            <div className="self-end hover:text-[#2A41C7]">
              <button
                className="flex font-[600] gap-1"
          ...
          {lihatDetail ? (
            <div className="p-4 mx-10 bg-[#FFFAE6]">
              <p className="text-[#344054] leading-[20px] font-[700] text-[14px] mb-4">
                Ringkasan Belanja
              </p>
              <div className="border-b text-[14px] pb-4 space-y-[8px] leading-[20px]">
                ...
                <div className="flex justify-between">
                  <p className="text-[#475467] font-[400]">Konsultasi</p>
                  <p className="text-[#344054] font-[700]">Rp 0 (gratis)</p>
                </div>
                <div className="flex justify-between">
                  <p className="text-[#475467] font-[400]">Kode unik</p>
                  <p className="text-[#344054] font-[700]">Rp 100</p>
                </div>
              </div>
        ...
        <div className="flex justify-between pt-8 pb-14 gap-8">
          <Link href={"/"}>
            <button className="px-[16px] py-[12px] bg-[#F2F4F7] hover:bg-[#E4E7EC] rounded-md w-full">
              <span className="text-[14px] font-semibold leading-[20px] cursor-pointer">
                Kembali ke halaman utama
              </span>
            </button>
          </Link>
          <button className="px-[16px] py-[12px] bg-[#3A57E8] hover:bg-[#2A41C7] rounded-md w-full text-white">
            <span className="text-[14px] font-semibold leading-[20px]">
              Upload bukti / Cek status pembayaran
            </span>
          </button>
        </div>
        <div className="border rounded-[8px] shadow-[0px_4px_16px_0px_rgba(58,87,232,0.1)] pt-4 pb-5">
          <div className="pb-4 border-b px-10">
            <span className="text-[#101828] text-[16px] leading-[20px] font-[500] tracking-[0.15px]">
          ...
          <div className="mx-10 py-5 spcae-y-[8px]">
            <div>
              <button
                ...
                onClick={() => handleActiveTataPembayaran(0)}
              >
              ...
              <div
                className={`px-[10px] py-[8px] bg-[#F2F4F7] ${
                  ActiveTataPembayaran === 0 ? "block" : "hidden"
                } `}
              >
                <ul className="list-disc ml-4 text-[14px] text-[#475467]">
                  ...
                  <li>
                    masukan jumlah uang yang akan ditransfer (pilih Benar)
                  </li>
                  <li>
                    Perhatikan konfirmasi transfer, jika benar pilih Benar
                  </li>
                  <li>
                    Transaksi telah selesai, pilih Keluar atau tekan Cancel.
                  </li>
                </ul>
              </div>
            </div>
            <div>
              <button
                ...
                onClick={() => handleActiveTataPembayaran(1)}
              >
              ...
              <div
                className={`px-[10px] py-[8px] bg-[#F2F4F7] ${
                  ActiveTataPembayaran === 1 ? "block" : "hidden"
                } `}
              >
                <ul className="list-disc ml-4 text-[14px] text-[#475467]">
                  <li>Pilih Transfer ke Tujuan Baru</li>
                  <li>
                    Masukan Nama Tujuan Bank Mandiri dan No Rekening (tap
                    Lanjut)
                  </li>
                  <li>
                    Pastikan Nama dan Rekening Penerima sudah Sesuai (tap
                    Lanjut)
                  </li>
            ...
            <div>
              <button
                ...
                onClick={() => handleActiveTataPembayaran(2)}
              >
                <span>Transfer via ATM Mandiri</span>
                {ActiveTataPembayaran === 2 ? (
                  <KeyboardArrowUpIcon />
              ...
              <div
                className={`px-[10px] py-[8px] bg-[#F2F4F7] ${
                  ActiveTataPembayaran === 2 ? "block" : "hidden"
                } `}
              >
                <ul className="list-disc ml-4 text-[14px] text-[#475467]">
                  ...
                  <li>
                    Pilih rekening asal, nominal, rekening tujuan transfer
                    (Lanjutkan)
                  </li>
                  <li>
                    Aktifkan token dan masukan PIN Token, lalu tekan angka 1
                    untuk masuk ke mode APPLI 1
                  </li>
                  <li>
                    Input challenge code yang terlihat pada layar PC (ada 8
                    digit)
                  </li>
