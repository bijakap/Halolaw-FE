  ...
  return (
    <div className="flex justify-center mx-10 w-auto">
      <div className="w-full pt-8">
        ...
        <div className="inline-block bg-white rounded-lg p-6 outline-[8px] outline-blue-500 mb-4">
          <div className="flex flex-row">
            <img src="/sidebar/layanan-hover.svg" alt="" />
            <div className="flex flex-col">
              <p>Tambah layanan baru</p>
              <p>Layanan pengurusan legalitas</p>
            </div>
