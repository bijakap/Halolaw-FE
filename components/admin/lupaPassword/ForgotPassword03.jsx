...
function ForgotPassword03(props) {
  ...
  const HandleSubmit = (e) => {
    ...
    if (
      ...
      Password.KonfirmasiPassword.length > 0
    ) {
    ...
    <div className="font-['Inter'] mt-20 mx-3 lg:mx-0">
      <div className="w-auto sm:w-[385px] mx-auto text-center flex flex-col justify-center bg-white">
        ...
        <div className="space-y-[16px] mb-10">
          <h5 className="text-[23px] leading-[32px] font-semibold text-[#1D2939]">
            Atur password baru
          </h5>
          <p className="text-[14px] leading-[20px] font-[400] tracking-[0.25px] text-[#475467]">
            Password baru Anda harus berbeda dari password yang digunakan
            sebelumnya
          </p>
        </div>
        <div className="text-left">
          <form onSubmit={(e) => HandleSubmit(e)}>
            <label className="text-sm font-medium text-gray-700 tracking-wide">
              Password <span className="text-[#3A57E8]">*</span>
            </label>
            <input
            ...
            />
            <label className="text-sm font-medium text-gray-700 tracking-wide">
              Konfirmasi Password <span className="text-[#3A57E8]">*</span>
            </label>
            <input
              className=" w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#3A57E8] mt-2 mb-6"
              required
