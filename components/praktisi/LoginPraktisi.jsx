...
function LoginPraktisi(){
    const router = useRouter()
    const handleLoginPraktisi = (e) => {
        e.preventDefault()
        router.push('/praktisi/')
    }

    return(
        <div className="flex w-screen h-auto font-['Inter']">
            <div className="hidden lg:block w-1/2 h-screen bg-[url('/loginPraktisi.png')] bg-cover">
            </div>
                ...
                <div className="pt-8 md:pt-0">
                    ...
                    <form action="#" className="space-y-[16px]">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <Link href="LupaPassword"><a href="/praktisi/LupaPassword" className="font-[600] text-sm text-gray-800">Lupa Password ?</a></Link>
                    ...
                    <button className="bg-white border-2 rounded-[8px] w-full py-[12px] flex justify-center font-[700] text-[#475467]"><img src="/google.svg" className="flex self-center h-auto pr-2"/>Sign in with Google</button>
