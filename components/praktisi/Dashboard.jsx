        ...
        <div className='overflow-x-auto'>
          <table className='table-auto w-full mt-4'>
            ...
            <tr className=''>
              ...
              <td className='md:px-10 px-3 bg-[#3A57E8] rounded-tr-lg'>
              <div className='flex'>
                  <p>Pendapatan</p>
                  <button>
                    <img src='/updown.svg'/>
            ...
            <tbody className='  '>
              {sampleData2.map((data, index) => (
                <tr key={index} className={` align-top text-center text-[14px] leading-[24px] text-[#232D42] ${index % 2 != 0 ? "bg-[#F4FAFF]" : "bg-white"}`}>
                  ...
                  <td className='py-2'>{data.tgl}</td>
                  <td className='text-left py-2'>{data.dokumen}</td>
                  <td className='text-left py-2 text-[#1B8920] font-bold leading-6 tracking-[0.25px]'>+ {data.pendapatan}</td>
                </tr>
              ))}
            </tbody>
          </table>
