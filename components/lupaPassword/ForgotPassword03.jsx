        ...
        <div className="font-['Inter'] mt-20">
            <div className="w-[385px] mx-auto text-center flex flex-col justify-center bg-white">
                ...
                <div className="text-left">
                    ...
                    <input className=" w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#3A57E8] mt-2 mb-6" type="email" placeholder="********"/>
