            ...
            <div className="w-auto sm:w-[385px] mx-auto text-center flex flex-col justify-center bg-white">
                ...
                <div className="text-left">
                    <form onSubmit={(e) => HandleSubmit(e)}>
                        ...
                        <input type="submit" value="Lanjutkan" className="w-full flex justify-center bg-[#3A57E8] hover:bg-[#2A41C7] text-gray-100 p-3 rounded-[8px] tracking-wide font-semibold cursor-pointer"/>
                    </form>
